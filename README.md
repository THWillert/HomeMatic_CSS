...
Dieses "überschreibt" die vorhandenen Style-Sheets, die von der CCU gelaenwerden, direkt im Browser.

### Installation
Nach der Installation von Stylus wird die CCS-Datei in Stylus importiert:

![WebUI Original](/images/HomeMatic_CSS__Stylus_bearbeit:
...
![WebUI Original](/images/HomeMatic_CSS__CSS-Varia
 ...
 1. Changelog, CSS-Variablen zum einfachen npassen ue ndetiren rck![WebUI Original](/images/HomeMatic_CSS__CSS-Variablen.png)![WebUI Original](/images/HomeMatic_CSS__Print.png)
 32. Allgemeine Stile
 . de restlichen Stile
 . ds Hintergrundbild
...
.
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTIzODM3MTAzLC05NzQ4MzUyMDNdfQ==
-->